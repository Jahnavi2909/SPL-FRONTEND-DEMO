  ...
  if (logo) {
    return (
      <img
        src={logo}
        alt={name}
        className="h-20 w-20 object-contain drop-shadow-[0_12px_24px_rgba(15,23,42,0.14)] sm:h-24 sm:w-24"
      />
    );
  }
        ...
        {loading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {formattedFranchises.map((franchise) => (
              <article
                key={franchise.id}
                className="group overflow-hidden rounded-[30px] border border-[#7b2d3b]/10 bg-white shadow-[0_18px_48px_rgba(15,23,42,0.08)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_56px_rgba(15,23,42,0.12)]"
              >
                  ...
                  <div className="mt-6 space-y-3">
                    <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-800">{franchise.owner}</p>
                      </div>
                    </div>
