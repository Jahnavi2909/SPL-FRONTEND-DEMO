export default function RoleCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`rounded-[14px] border p-3 text-left transition-all duration-300 ${
        active
    ...
    >
      <div className="text-[1rem]">{icon}</div>
      <div className="mt-2 text-[14px] font-semibold text-slate-900 sm:text-[15px]">
        {title}
      </div>
