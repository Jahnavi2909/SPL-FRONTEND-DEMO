...
import PlayerInfo from "../pages/franchise/PlayerInformation";
...
import Teams from "../pages/franchise/Teams";
  ...
  return (
    ...
    <Route path="/admin/latest-news" element={<AdminLatestNewsPage />} />
      ...
      >
        ...
        <Route path="/franchise/player-info" element={<PlayerInfo />} />
        <Route path="/franchise/teams" element={<Teams/>} />
